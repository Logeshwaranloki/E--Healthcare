...
if(mysqli_num_rows($retval)>0)
{
  ...
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src='<?php echo $pi;?>' style='height:300px;width:300px'>
    </div>
    <div class="flip-box-back">
      <br><br><br><h5><?php echo $pn;?></h5>
	  <p><b>Price: <?php echo $pr;?></p>
	  <p>Expiry Date: <?php echo $edt;?></p>
	  <p>Description: <?php echo $dt;?></b></p>
	  <p><a href="admin_modify_medicine.php?id='<?php echo $pid;?>'">Update Stock</a></p>
    </div>
  </div>
</div>
		...
		//<a href='addcart1.php?pi=$pid'>ADD CART</a>
