...
<body style="background-image:url('images/3.gif');
background-size:cover;
backgroung-width:100%">
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            <a href="" class="navbar-brand d-block d-lg-none">
                <h1 class="m-0 display-5 text-capitalize font-italic text-white"><span class="text-primary">ONLINE </span>MOBILE SHOPPING</h1>
            </a>
...
<a href="customerhome.php">Home</a>
	<!--<a href="cus_header.php">Home</a>
	<!--<a href="update_profile1.php">Updateprofile</a>
	<a href="recharge.php">Recharge_wallet</a>-->
	<!--<a href="customer_category.php">Category</a>
	<a href="all_products.php">Products</a>
	<a href="filter.php">Filter</a>
	<a href="mycart.php">Mycart</a>
	<a href="myorder.php">Myorder</a>
	<a href="mydeliver.php">Mydelivery</a>
	<a href="myreturn.php">Return</a>
	<a href="mycancel.php">Cancel</a>
	<a href="mobile_home.php">Logout</a>
 -->
 
                    <a href="customerhome.php" class="nav-item nav-link active">Home</a>
                    <a href="customer_category.php" class="nav-item nav-link">Category</a>
                    <a href="all_products.php" class="nav-item nav-link">Products</a>
                    ...
                    <a href="mydeliver.php" class="nav-item nav-link"> My delivery</a>
                    <a href="myreturn.php" class="nav-item nav-link"> Return</a>
                    <a href="mycancel.php" class="nav-item nav-link"> Cancel</a>
                    <a href="clogout.php" class="nav-item nav-link"> Logout</a>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                   <!--<img class="w-100" src="images/3.webp" alt="Image">-->
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <!--<h3 class="text-white mb-3 d-none d-sm-block">SHOP AT DOOR STEP</h3>-->
                            <h1 class="display-3 text-white mb-3">ONLINE MOBILE SHOPPING</h1>
