...
<body style="background-image:url('images/4.gif');
background-size:cover;
backgroung-width:100%">    <!-- Topbar Start -->
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            <a href="" class="navbar-brand d-block d-lg-none">
                <h1 class="m-0 display-5 text-capitalize font-italic text-white"><span class="text-primary">SHOP AT</span>DOOR STEP</h1>
            </a>
 ...
 <div class="navbar-nav mr-auto py-0">
					 ...
					 <a href="dbhome.php" class="nav-item nav-link">Home</a>
					 <a href="vieworderdb.php" class="nav-item nav-link">Orders</a>
					 <a href="viewdord.php" class="nav-item nav-link"> Delivered Order</a>
					 

					 <a href="userprofileupdate.php" class="nav-item nav-link">Profile Update</a>
					 <a href="dblogout.php" class="nav-item nav-link">Log Out</a>


                  <!-- <a href="shop.php" class="nav-item nav-link active">Add Shop</a>
                    <a href="manageshop.php" class="nav-item nav-link">Manage  Shop</a>
					<a href="addproduct.php" class="nav-item nav-link">Add Product</a>
					 <a href="manageproduct.php" class="nav-item nav-link">Delete Product</a>
					 <a href="adddeliveryboy.php" class="nav-item nav-link">Add Delivery boy</a>
                    <a href="deletedeliveryboy.php" class="nav-item nav-link">remove Delivery boy</a>-->
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <!--<h3 class="text-white mb-3 d-none d-sm-block">SHOP AT DOOR STEP</h3>-->
                              <!--<h1 class="display-3 text-white mb-3">SHOP AT DOOR STEP</h1>-->
                              <!--<h5 class="text-white mb-3 d-none d-sm-block">SHOP AT DOOR STEP</h5>-->
