...
<head>
  ...
  <title>E-Healthcare Shopping</title>
...
<body>
  <div class="hero_area">
    ...
    <!-- end header section -->
    <!-- slider section -->
    <section class=" slider_section position-relative" style="background-image:url(img/bg13.jpg);background-size:cover;height:800px">
                  ...
                  <div class="row">
                    <div class="offset-md-2 col-md-4">
                      <div class="slider_item-detail">
                        <div>
                          <h1 style="margin:200px 20px;color:black">
                           Health Care Providers Provide you the Suggestion Video
                          </h1>
